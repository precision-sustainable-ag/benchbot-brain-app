...
then 
	...
	then 
		...
		check
		echo 'SVS_GENICAM_CACHE="/opt/SVS/SVCamKit/SDK/Linux64_ARM/cache/"' >> /etc/environment
		echo 'SVS_SDK_BIN_64="/opt/SVS/SVCamKit/SDK/Linux64_ARM/"' >> /etc/environment
		echo 'GENICAM_GENTL64_PATH="/opt/SVS/SVCamKit/SDK/Linux64_ARM/cti"' >> /etc/environment
		check
	fi
